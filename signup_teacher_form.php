			...
			jQuery("#signin_teacher").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome to DiGitC-DIGITAL CLASSROOM", { header: 'Sign up Success' });
						var delay = 1000;
						...
						{
						$.jGrowl("Your password does not match", { header: 'Sign Up Failed' });
						}
				});
			});
			</script>
			<a onclick="window.location='teacher_login.php'" id="btn_login" name="login" class="btn" type="submit"><i class="icon-signin icon-large"></i> Click here to Login</a>
