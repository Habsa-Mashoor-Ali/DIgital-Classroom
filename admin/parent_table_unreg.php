<?php include('dbcon.php'); ?>
	...
	<?php include('modal_delete.php'); ?>
		...
		<?php
	$query = mysqli_query($conn,"select * from parent LEFT JOIN student ON parent.student_id = student.student_id where status = 'Unregistered' ORDER BY parent.parent_id DESC") or die(mysqli_error());
