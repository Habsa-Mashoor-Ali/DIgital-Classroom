                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Total lecturers</strong>
                                ...
                                <div class="span3">
                                    <div class="chart" data-percent="<?php echo $count_student ?>"><?php echo $count_student ?></div>
                                    <div class="chart-bottom-heading"><strong>Total Students</strong>
...
<!-- 								
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Total Courses</strong>
